...
# state_dict = torch.load(r'E:\AdaIN\experiment\trial2\decoder_1.pth')
...
decoder.load_state_dict(torch.load('experiment/run_10/decoder_1.pth', map_location=torch.device('cpu')))
...
def send_example(filename):
    examples_dir = os.path.join(app.root_path, 'static', 'examples')
